...
//----------------------------------------------------------------------------
void showGoodMatches( const cv::Mat & imageFrame, const std::vector<KeyPoint> & keypoints_image, const cv::Mat & exampleFrame, const std::vector<KeyPoint> & keypoints_example, const std::vector< DMatch > & good_matches)
{
  Mat img_matches;
...
//----------------------------------------------------------------------------
void detectRobot(const cv::Mat & current, std::vector<KeyPoint> & keypoints_current,  cv::Mat & descriptors_current, cv::Mat & currentFrame, boolean & detect)
{
  cv::Point2f cen(0,0);
  ...
  if (min_dist < 0.2)
    {
      ...
      //showGoodMatches(currentFrame, keypoints_current, robotTemplate, keypoints_template, good_matches);
...
void computeRobotTransform(const std::vector<KeyPoint> & keypoints_current, const cv::Mat & descriptors_current, const cv::Mat & currentFrame)
{
    ...
    //showGoodMatches(lastFrame, keypoints_last, currentFrame, keyPoints_current, good_matches);
...
void trackRobot(const cv::Mat & current)
{
  ...
  void detectRobot(current, keypoints_current, descriptors_current, currentFrame, detect);
  if (detect && lastdetect)
    void computeRobotTransform(keypoints_current, descriptors_current, currentFrame);
